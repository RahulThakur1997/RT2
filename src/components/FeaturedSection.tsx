...
export const FeaturedSection: React.FC<FeaturedSectionProps> = ({ onOpenQuoteModal }) => {
  return (
    <section id="featured-roofing" className="bg-[#040205] text-white py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-[8px] overflow-hidden shadow-2xl bg-[#040205] aspect-[4/3] sm:aspect-[16/11]">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#040205]/70 via-transparent to-black/20" />
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-200 leading-relaxed">
              Whether your roof needs attention today or you're planning a larger project, A T Roofing Birmingham can help you understand the work required and provide a clear route forward.
            </p>

            {/* Value checklist */}
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                <CheckCircle2 className="w-5 h-5 text-[#C80103] shrink-0" />
            ...
            <div className="pt-4">
              <button
                ...
                className="px-7 sm:px-9 py-3.5 sm:py-4 rounded-md bg-[#C80103] hover:bg-[#a50102] text-white font-heading font-bold text-sm sm:text-base tracking-wider uppercase shadow-xl flex items-center gap-2.5 transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
              >
