...
// Extend existing Keystone review items with authentic Google review time stamps
...
// Row 1 & Row 2 sequences with alternating ordering of Keystone's genuine reviews
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            {review.avatarUrl ? (
              ...
              <div
                className="w-9 h-9 sm:w-9.5 sm:h-9.5 rounded-full bg-[#242F6B]/10 border border-[#242F6B]/15 text-[#242F6B] font-heading font-bold text-xs sm:text-[13px] flex items-center justify-center shrink-0"
                aria-hidden="true"
              >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <span className="font-heading font-semibold text-[13px] sm:text-[13.5px] text-[#242F6B] truncate leading-tight">
                  {review.customerName}
                </span>
                <CheckCircle
          ...
          <button
            ...
            className="text-[11px] sm:text-[11.5px] font-semibold text-[#ac0e13] hover:underline cursor-pointer mt-1 inline-block text-left"
          >
            Read more
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 text-center mb-10 sm:mb-12 lg:mb-16">
        ...
        <p className="text-[12px] sm:text-[13px] font-heading font-bold text-[#ac0e13] tracking-[0.16em] uppercase mb-4 sm:mb-5">
          SOCIAL PROOF
        </p>

        {/* Large Heading: Center-aligned, single line on desktop if naturally fits */}
        <h2 className="font-heading text-[30px] xs:text-[32px] sm:text-[36px] md:text-[42px] lg:text-[46px] xl:text-[48px] font-extrabold text-[#242F6B] leading-[1.08] tracking-tight text-center max-w-[960px] mx-auto">
          Trusted by Homeowners Across Reading &amp; Berkshire
        </h2>
      </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute top-4 right-4 w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-[#242F6B] flex items-center justify-center transition-colors cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="flex items-center gap-3 mb-4">
              {selectedReview.avatarUrl ? (
                ...
                <div className="w-11 h-11 rounded-full bg-[#242F6B]/10 border border-[#242F6B]/15 text-[#242F6B] font-heading font-bold text-base flex items-center justify-center shrink-0">
                  {selectedReview.customerName.charAt(0) || 'K'}
                </div>
              )}
              <div>
                <div className="flex items-center gap-1.5">
                  <h4 id="review-modal-title" className="font-heading font-bold text-base text-[#242F6B]">
            ...
            <div className="flex items-center gap-1 mb-3">
              ...
              <span className="text-xs font-bold text-[#242F6B] ml-1.5">5.0 out of 5</span>
            </div>
            ...
            <div className="pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
              ...
              <span className="font-medium text-[#242F6B] bg-[#242F6B]/10 px-2.5 py-1 rounded-md">
