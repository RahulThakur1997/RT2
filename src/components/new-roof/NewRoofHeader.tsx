    ...
    <>
      ...
      <header
        ...
        className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-[#151D45]/95 backdrop-blur-md shadow-lg py-3.5 border-b border-white/10'
            : 'bg-gradient-to-b from-[#151D45]/90 via-[#151D45]/60 to-transparent py-4 sm:py-5 border-b border-white/10'
        }`}
      >
        <div className="max-w-[1240px] mx-auto px-5 sm:px-6 lg:px-8 flex items-center justify-between">
          {/* LEFT: Keystone Logo (Clicking navigates to Home) */}
          <button
            type="button"
            onClick={() => onNavigateHome()}
            aria-label="Keystone Roofing & Building - Go to Homepage"
          ...
          <div className="hidden sm:flex items-center gap-4 lg:gap-5">
            <a
              ...
              title="Free Phone Keystone Roofing"
            >
            ...
            <a
              ...
              title="Call Keystone Roofing"
            >
              <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-[#ac0e13] transition-colors">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-md bg-[#242F6B] hover:bg-[#1b2352] text-white border border-white/30 text-xs font-heading font-semibold tracking-wider uppercase transition-all duration-200 shadow-sm cursor-pointer hover:border-white/60"
            >
              Get a Quote
            </button>
          </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div
            className="w-[280px] xs:w-[320px] bg-[#151D45] h-full p-6 flex flex-col justify-between shadow-2xl text-white border-l border-white/15"
          ...
          >
              ...
              <nav className="flex flex-col gap-3.5 mt-6 text-sm font-heading font-medium">
                ...
                <div className="py-2 border-b border-white/10">
                  ...
                  <div className="pl-2 space-y-2 text-xs">
                    <div className="text-white font-bold text-[#ac0e13] bg-[#ac0e13]/20 px-2 py-1 rounded">
            ...
            <div className="pt-6 border-t border-white/15 space-y-2.5">
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <div className="flex items-center gap-1">
                    <Phone className="w-3 h-3 text-[#ac0e13]" />
              ...
              <button
                ...
                className="w-full py-3 rounded-md bg-[#242F6B] hover:bg-[#1b2352] text-white border border-white/30 text-xs font-heading font-bold uppercase tracking-wider text-center"
              >
                Get a Quote
              </button>
            </div>
