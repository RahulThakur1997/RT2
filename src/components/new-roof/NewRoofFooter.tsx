...
export const NewRoofFooter: React.FC<NewRoofFooterProps> = ({
  ...
  return (
    <>
      <footer id="service-footer" className="bg-[#242F6B] text-white pt-16 sm:pt-20 pb-12 border-t border-white/10">
        <div className="max-w-[1240px] mx-auto px-5 sm:px-6 lg:px-8">
          {/* TOP SECTION: Callout & Large Phone on Left, Keystone Logo on Right */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-12 border-b border-white/15">
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                <a
                  ...
                  className="font-heading font-extrabold text-2xl sm:text-3xl md:text-4xl text-white hover:text-[#ac0e13] transition-colors tracking-tight block"
                >
                  {BUSINESS_INFO.phone}
                </a>
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="px-6 py-3 rounded-md bg-[#ac0e13] hover:bg-[#920b10] text-white font-heading font-bold text-xs sm:text-sm tracking-wider uppercase transition-colors shadow-sm"
              >
                Get a Free Quote
              </button>
            ...
            <div>
              ...
              <div className="space-y-3.5 text-xs sm:text-sm text-gray-300">
                <div className="font-semibold text-white">
                  Keystone Roofing &amp; Building Limited
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  <Phone className="w-4 h-4 text-[#ac0e13] shrink-0" />
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
            <div>
              &copy; {new Date().getFullYear()} Keystone Roofing &amp; Building Limited. All rights reserved. Registered in England &amp; Wales.
            </div>
              ...
              <button
                ...
                onClick={() =>
                  setLegalModal({
                    ...
                    body: 'Keystone Roofing & Building Limited respects your privacy and is committed to protecting your personal data. We only collect information strictly required to respond to your roofing quote requests and deliver our contracted services.'
                  })
                }
                className="hover:text-white transition-colors cursor-pointer"
              >
      ...
      {legalModal && (
        ...
        >
          ...
          >
            <h4 className="font-heading font-bold text-base text-[#242F6B] mb-3">{legalModal.title}</h4>
            <p className="text-xs text-gray-600 leading-relaxed mb-5">{legalModal.body}</p>
            <div className="text-right">
              <button
                type="button"
                onClick={() => setLegalModal(null)}
                className="px-4 py-2 bg-[#242F6B] text-white rounded text-xs font-semibold cursor-pointer"
              >
                Close
              </button>
            </div>
